 ...
 * @author MY PC
 */
public class MadaniyyahGUI extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    public MadaniyyahGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jListSuratMadaniyyah = new javax.swing.JList<>();
        ...
        jListSuratMadaniyyah.setOpaque(false);
        jPanel1.add(jListSuratMadaniyyah, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 410, 470));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/2.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 410, 470));
        ...
        labelKategori.setText("Madaniyyah");
    ...
    public void setSuratMadaniyyahList(DefaultListModel model) {
        jListSuratMadaniyyah.setModel(model);
    }
    ...
    public JList getList() {
        return jListSuratMadaniyyah;
    }

    public int getIndexListTerpilih() {
        return jListSuratMadaniyyah.getSelectedIndex();
    }
    ...
    public void addMouseAdapter(MouseAdapter e) {
        jListSuratMadaniyyah.addMouseListener(e);
    }
    ...
    private javax.swing.JList<String> jListSuratMadaniyyah;
