 ...
 * @author MY PC
 */
public class CcariSuratGUI extends MouseAdapter implements ActionListener {
    
    public Player mp3;
    private CariSuratGUI view;
    private Application model;
    private CkategoriGUI CK;
    private final JFXPanel fxPanel = new JFXPanel();
    private boolean playing = false;
    
    public CcariSuratGUI(Application model) {
        this.model = model;
        view = new CariSuratGUI();
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (source.equals(view.getBtnCari())) {
            String namaDicari = view.getTfNamaSurat();
            model.searchSurat(namaDicari);
