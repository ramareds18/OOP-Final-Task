 ...
 * @author MY PC
 */
public class CsuratMakiyyahGUI extends MouseAdapter implements ActionListener {
    
    public Player mp3;
    private MakiyyahGUI view;
    private Application model;
    private CkategoriGUI CK;
    private final JFXPanel fxPanel = new JFXPanel();
    private boolean playing = false;
    
    public CsuratMakiyyahGUI(Application model) {
        this.model = model;
        view = new MakiyyahGUI();
        view.setVisible(true);
        view.addActionListener(this);
        view.addMouseAdapter(this);
        model.loadSuratMakiyyahList();
        view.setSuratMakiyyahList(model.getDLMSuratMakiyyahList());
    }
